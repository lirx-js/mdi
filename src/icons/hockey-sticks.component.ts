...
/**
 * Component: "icon-hockey-sticks"
 */

export const IconHockeySticksComponent = createIconComponent(
  "icon-hockey-sticks",
  "<path d=\"M17.68 4H14.3l-1.74 4c-.03.04-.11.22-.25.5s-.25.54-.31.69L9.7 4H6.32l4.09 8.84c.09.22.32.75.7 1.59.39.85.67 1.48.89 1.92l1.41 3.09c.19.34.48.51.89.51L19 20v-4h-4l-1.4-3.16L17.68 4m2.35 12v4H22v-3c0-.27-.09-.5-.28-.72-.19-.2-.42-.28-.72-.28h-.97M5 16v4l4.7-.05c.41 0 .7-.17.89-.51l.85-1.94-1.6-3.44L9 16H5m-3 4h1.97v-4H3c-.3 0-.53.08-.72.28-.19.22-.28.45-.28.72v3Z\"/>",
