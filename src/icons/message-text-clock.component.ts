...
/**
 * Component: "icon-message-text-clock"
 */

export const IconMessageTextClockComponent = createIconComponent(
  "icon-message-text-clock",
  "<path d=\"M22 12.41V4a2 2 0 0 0-2-2H4c-1.1 0-2 .9-2 2v18l4-4h3.29A7.001 7.001 0 0 0 23 16c0-1.31-.37-2.54-1-3.59M6 6h12v2H6V6m10 3c-1.9 0-3.63.77-4.89 2H6V9h10M6 12h4.26c-.42.6-.76 1.28-.96 2H6v-2m10 8.85c-2.68 0-4.85-2.17-4.85-4.85s2.17-4.85 4.85-4.85c2.67 0 4.85 2.17 4.85 4.85s-2.18 4.85-4.85 4.85m.5-5.03 2.44 1.41-.75 1.3L15 16.69V13h1.5v2.82Z\"/>",
